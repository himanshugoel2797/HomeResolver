...
class EnergyManagement(App):
    ...
    def __init__(self, target_elect_bill, instantaneous_max_bill):
        self.target_elect_bill = target_elect_bill
        self.instantaneous_max_bill = instantaneous_max_bill
        self.cur_bill = 0
    ...
    def update(self, sys):
        ...
        if avail_cost > self.instantaneous_max_bill:
            avail_cost = self.instantaneous_max_bill
